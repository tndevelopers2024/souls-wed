...
export default function VendorSidebar({ vendor }: VendorSidebarProps) {
  ...
  return (
    <div className="sticky top-24 flex flex-col gap-6">
      ...
      {/* Destination Price */}
      <div className="bg-orange-50/50 p-5 border-t border-slate-100 border border-slate-200 rounded-xl mt-4 shadow-sm">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
        ...
        <BookingForm
          ...
          bookingTypes={[
            {
              value: "venue",
              label: `Book ${vendor.category}`,
            },
          ]}
          pricePerPlateVeg={(vendor.priceFrom || 50000).toString()}
          pricePerPlateNonVeg={(Math.round((vendor.priceFrom || 50000) * 1.2)).toString()}
          rentalCost={(vendor.priceFrom ? vendor.priceFrom * 5 : 250000).toString()}
