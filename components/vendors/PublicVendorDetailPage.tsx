...
function VendorGallery({ images, name }: { images: string[]; name: string }) {
  if (!images || images.length === 0) return <p className="text-sm text-slate-500 dark:text-stone-400">No images available.</p>;
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
      {images.map((img, idx) => (
        <div key={idx} className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-sm border border-slate-100 dark:border-white/10 group">
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 items-center bg-primary-50/40 p-6 rounded-2xl mb-8 border border-primary-100">
      <div className="text-center md:border-r border-primary-200/50 md:pr-10 shrink-0">
        ...
        <p className="text-xs font-bold text-slate-500 dark:text-stone-400 uppercase tracking-wider">{count} Reviews</p>
      </div>
      <div className="flex-1 text-slate-600 dark:text-stone-300 text-sm italic font-medium max-w-lg text-center md:text-left">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-28 pb-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10">
          ...
          <div className="space-y-10">
            ...
            {/* Tab Navigation */}
            <div className="sticky top-20 z-40 bg-white/95 dark:bg-[var(--sw-surface)]/95 backdrop-blur-md border-b border-slate-200 dark:border-white/10 py-4 -mx-4 px-4 sm:mx-0 sm:px-0 mt-6 shadow-sm">
              <div className="flex items-center gap-6 overflow-x-auto no-scrollbar pb-1">
                ...
                <a href="#about" className="text-sm font-semibold text-slate-600 dark:text-stone-300 hover:text-primary-600 pb-1 whitespace-nowrap transition-colors">About</a>
                <a href="#gallery" className="text-sm font-semibold text-slate-600 dark:text-stone-300 hover:text-primary-600 pb-1 whitespace-nowrap transition-colors">Gallery</a>
                <a href="#pricing" className="text-sm font-semibold text-slate-600 dark:text-stone-300 hover:text-primary-600 pb-1 whitespace-nowrap transition-colors">Pricing</a>
                <a href="#reviews" className="text-sm font-semibold text-slate-600 dark:text-stone-300 hover:text-primary-600 pb-1 whitespace-nowrap transition-colors">Reviews</a>
              </div>
            </div>
            ...
            <section id="areas" className="scroll-mt-32">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-4 p-4 rounded-2xl border border-slate-100 dark:border-white/10 hover:border-primary-200 transition-colors bg-white dark:bg-[var(--sw-surface)] shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-800 dark:text-stone-200 text-sm">200 Seating | 300 Floating</h4>
                ...
                <div className="flex items-start gap-4 p-4 rounded-2xl border border-slate-100 dark:border-white/10 hover:border-primary-200 transition-colors bg-white dark:bg-[var(--sw-surface)] shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-800 dark:text-stone-200 text-sm">500 Seating | 800 Floating</h4>
                    <p className="text-xs text-slate-500 dark:text-stone-400 mt-1">Outdoor • Lawn</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mt-5">
                {["Air Conditioned", "Parking Available", "Power Backup"].map((f) => (
                  <span key={f} className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full border border-slate-200 dark:border-white/10 text-slate-600 dark:text-stone-300">
            ...
            <section id="about" className="scroll-mt-32">
              ...
              <p className="text-slate-600 dark:text-stone-300 leading-relaxed text-[15px]">
            ...
            <section id="pricing" className="scroll-mt-32">
              ...
              <div className="rounded-[24px] overflow-hidden border border-slate-100 dark:border-white/10" style={{ background: "white" }}>
                
                {isPerPlate ? (
                  <>
                    <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-white/10">
                      <div>
                        <p className="font-semibold text-slate-800 dark:text-stone-200 text-sm">Veg Menu</p>
                        <p className="text-xs text-slate-400 dark:text-stone-500">Per plate, inclusive of taxes</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-white/10">
                      <div>
                        <p className="font-semibold text-slate-800 dark:text-stone-200 text-sm">Non-Veg Menu</p>
                        <p className="text-xs text-slate-400 dark:text-stone-500">Per plate, inclusive of taxes</p>
                      </div>
                      <p className="text-lg font-bold" style={{ color: "var(--sw-navy)" }}>
                    ...
                    {isVenue && (
                      <div className="flex items-center justify-between px-6 py-4">
                        <div>
                          <p className="font-semibold text-slate-800 dark:text-stone-200 text-sm">Venue Rental</p>
                          <p className="text-xs text-slate-400 dark:text-stone-500">Full-day exclusive use</p>
                        </div>
                  ...
                  <div className="flex items-center justify-between px-6 py-4">
                    <div>
                      <p className="font-semibold text-slate-800 dark:text-stone-200 text-sm">Room Rate</p>
                      <p className="text-xs text-slate-400 dark:text-stone-500">Per room per night, inclusive of taxes</p>
                    </div>
                    <p className="text-lg font-bold text-primary-600">
                      {vendor.priceFrom ? formatAsCurrency(vendor.priceFrom, currency) : "On request"}
                    </p>
                  ...
                  <div className="flex items-center justify-between px-6 py-4">
                    <div>
                      <p className="font-semibold text-slate-800 dark:text-stone-200 text-sm">Starting Package</p>
                      <p className="text-xs text-slate-400 dark:text-stone-500">Fixed starting fee for services</p>
                    </div>
                    <p className="text-lg font-bold text-primary-600">
                      {vendor.priceFrom ? formatAsCurrency(vendor.priceFrom, currency) : "On request"}
                    </p>
            ...
            <section id="reviews" className="scroll-mt-32">
              <h2 className="text-2xl font-bold mb-6" style={{ fontFamily: "var(--font-heading)", color: "var(--sw-navy)" }}>
                Reviews <span className="text-slate-400 dark:text-stone-500 ml-2 text-xl">({(vendor.reviewCount || 0) > 0 ? vendor.reviewCount : 2})</span>
              </h2>
            ...
            <section id="faq" className="scroll-mt-32">
              ...
              <div className="space-y-3">
                {faqs.map((faq, i) => (
                  <div key={i} className="rounded-[20px] overflow-hidden border border-slate-100 dark:border-white/10" style={{ background: "white" }}>
                    <button className="w-full flex items-center justify-between px-5 py-4 text-left gap-3 outline-none" onClick={() => setOpenFaq(openFaq === i ? null : i)}>
                      ...
                      <ChevronDown className="w-4 h-4 flex-shrink-0 text-slate-400 dark:text-stone-500 transition-transform" style={{ transform: openFaq === i ? "rotate(180deg)" : "rotate(0)" }} />
                    </button>
                    {openFaq === i && (
