...
export default function Footer() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-2 lg:pr-12">
              <Link href="/" className="flex items-center gap-3 mb-5 group inline-flex">
                <div className="w-11 h-11 rounded-full bg-gradient-to-tr from-amber-400 via-amber-500 to-orange-500 flex items-center justify-center shadow-lg shadow-orange-500/10 group-hover:rotate-6 transition-transform duration-300">
                  <Heart className="w-5 h-5 text-white fill-current" />
                </div>
                <span
                  className="text-2xl md:text-3xl font-extrabold tracking-tight text-slate-800"
                >
                  SoulsWed
                </span>
              </Link>
      ...
      <a
        href="/book"
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 text-sm font-bold px-5 py-3 rounded-full shadow-xl transition-all hover:scale-105 hover:shadow-2xl"
        style={{
