  ...
  return (
    ...
    >
      <span className="relative inline-flex items-center justify-center">
        <SunIcon className={`${iconSize} rotate-0 scale-100 transition-all duration-300 dark:-rotate-90 dark:scale-0`} />
        <MoonIcon className={`${iconSize} absolute rotate-90 scale-0 transition-all duration-300 dark:rotate-0 dark:scale-100`} />
      </span>
    </button>
  );
}
