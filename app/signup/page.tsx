        ...
        <div className="flex bg-slate-100 p-1 rounded-2xl mb-8 relative z-0">
          ...
          <button
            ...
            className={`flex-1 text-center py-2.5 text-xs font-bold transition-colors ${
              role === "user" ? "text-slate-900" : "text-slate-505 hover:text-slate-700"
            }`}
          >
            User Registration
          </button>
          <button
            ...
            className={`flex-1 text-center py-2.5 text-xs font-bold transition-colors ${
              role === "vendor" ? "text-slate-900" : "text-slate-555 hover:text-slate-700"
            }`}
          >
            Vendor Registration
          </button>
              ...
              <>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    <input
                      type="text"
                      placeholder="e.g. Dream Event Decor"
                      value={businessName}
