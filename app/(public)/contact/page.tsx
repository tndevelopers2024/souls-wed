              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
                  <div className="space-y-2">
                    ...
                    <input id="firstName" name="firstName" type="text" className="w-full text-sm bg-white/50 border border-slate-200 dark:border-white/10/60 rounded-xl px-5 py-3 outline-none focus:bg-white dark:bg-[var(--sw-surface)] focus:ring-4 focus:ring-primary-500/10 focus:border-primary-400 transition-all text-slate-800 dark:text-stone-200 placeholder-slate-400 font-medium shadow-sm" placeholder="Your First Name" required />
                  </div>
                ...
                <div className="space-y-1">
                  ...
                  <textarea id="message" name="message" rows={4} className="w-full text-sm bg-white/50 border border-slate-200 dark:border-white/10/60 rounded-xl px-5 py-3 outline-none focus:bg-white dark:bg-[var(--sw-surface)] focus:ring-4 focus:ring-primary-500/10 focus:border-primary-400 transition-all text-slate-800 dark:text-stone-200 placeholder-slate-400 font-medium resize-none shadow-sm" placeholder="Tell us about your vision, preferred destinations, or any dates you have in mind..." required></textarea>
                </div>
                <button 
                  type="button" 
