    ...
    <main className="min-h-screen pt-32 pb-16 relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-800 dark:text-stone-200 mb-6 font-heading">
            Our <span className="text-primary-500">Story</span>
          </h1>
          <p className="text-lg text-slate-600 dark:text-stone-300 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slate-800 dark:text-stone-200 mb-6 font-heading">The Heritage</h2>
            <p className="text-slate-600 dark:text-stone-300 mb-6 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-6 mt-8 border-t border-amber-200/60 pt-8">
               ...
               <div>
                  ...
                  <p className="text-sm font-semibold tracking-wide text-slate-500 dark:text-stone-400 mt-2 uppercase">Destinations</p>
               </div>
            </div>
          </div>
        </div>
